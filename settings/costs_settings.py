...
w_non_coding_region = 2.  # transversion substitutions
x_non_coding_region = 1.  # transition substitutions
...
non_coding_region_cost_description = f'Within non-coding sections, altering bases within complementary pairs (A to G, G to A, C to T, T to C) incurs a cost of {x_non_coding_region}.' \
                                     f'\nSubstituting one base for another (e.g., A to T or G to C) raises the expense to {w_non_coding_region}.\n'
