...
class EliminationWindow(QWidget):
    def __init__(self, dna_sequence, unwanted_patterns, original_coding_regions, original_region_list, selected_regions_to_exclude,
        ...
        self.back_to_processing_callback = back_to_processing_callback
    ...
    def add_back_button(self, layout):
        ...
        back_button.clicked.connect(self.back_to_processing_callback)
    ...
    def display_info(self, layout):
        ...
        info += marked_seq
        info += SequenceUtils.get_sequence("Target DNA sequence", target_seq)
        ...
        self.prompt_report(self.middle_layout, target_seq, marked_input_seq, marked_target_seq,
                           self.original_coding_regions, self.original_region_list, self.selected_regions_to_exclude,
                           self.selected_region_list, min_cost)
    ...
    def save_report(self, layout, seq, target_seq, marked_input_seq, marked_target_seq, unwanted_patterns,
        ...
        self.done_button.setFocus(True)
