...
class TestEliminationController(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher_usage = patch("data.app_data.CostData.codon_usage",
                                   new={'TTT': 0.94, 'TCT': 0.4, 'TAT': 0.89, 'TGT': 0.85, 'TTC': 0.06, 'TCC': 0.05,
                                        'TAC': 0.11, 'TGC': 0.15, 'TTA': 0.67, 'TCA': 0.23, 'TAA': 0.91, 'TGA': 0.02,
                                        'TTG': 0.07, 'TCG': 0.03, 'TAG': 0.06, 'TGG': 1.0, 'CTT': 0.19, 'CCT': 0.51,
                                        'CAT': 0.86, 'CGT': 0.34, 'CTC': 0.01, 'CCC': 0.04, 'CAC': 0.14, 'CGC': 0.05,
                                        'CTA': 0.05, 'CCA': 0.4, 'CAA': 0.94, 'CGA': 0.23, 'CTG': 0.01, 'CCG': 0.05,
                                        'CAG': 0.06, 'CGG': 0.02, 'ATT': 0.65, 'ACT': 0.51, 'AAT': 0.88, 'AGT': 0.26,
                                        'ATC': 0.04, 'ACC': 0.05, 'AAC': 0.12, 'AGC': 0.03, 'ATA': 0.3, 'ACA': 0.4,
                                        'AAA': 0.95, 'AGA': 0.34, 'ATG': 1.0, 'ACG': 0.04, 'AAG': 0.05, 'AGG': 0.02,
                                        'GTT': 0.54, 'GCT': 0.58, 'GAT': 0.91, 'GGT': 0.43, 'GTC': 0.04, 'GCC': 0.05,
                                        'GAC': 0.09, 'GGC': 0.05, 'GTA': 0.38, 'GCA': 0.34, 'GAA': 0.93, 'GGA': 0.45,
                                        'GTG': 0.04, 'GCG': 0.03, 'GAG': 0.07, 'GGG': 0.06}
                                   )
